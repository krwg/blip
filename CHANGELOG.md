...
- **Maintainability** — call IPC extracted to `main/ipc/calls.js`; semver helpers to `renderer/app-version.js`; main nav/unread host to `renderer/view-router.js`; group-call mesh/signalling to `renderer/group-call-signalling.js` (#58, #59).
